...
const Gaz = ({ navigation }) => {
 ...
 const sum = () => {
     ...
     let p;
       ...
       p = (result * countKvt) + (result1 * countKvt);
 ...
 return (
   <ImageBackground
     ...
     style={{ flex: 1 }}
   >
<Text style={{...FONTS.h1, marginTop: SIZES.padding * 3, alignSelf:'center', color:COLORS.red}}>Газ</Text>
     <View
       style={{
         flexDirection: "row",
     ...
     >
       ...
       <View style={{ width: "25%" }}>
         ...
         <Text style={{alignSelf:'center',color:COLORS.red, ...FONTS.body3, textDecorationLine:'underline'}}>{result}</Text>
       </View>

       <View style={{ width: "25%" }}>
         <Text style={{ color: COLORS.white, ...FONTS.body3 }}>Цена за доставку</Text>
         <Text style={{alignSelf:'center' ,color:COLORS.red, ...FONTS.body3, textDecorationLine:'underline'}}>{result1}</Text>
       </View>
